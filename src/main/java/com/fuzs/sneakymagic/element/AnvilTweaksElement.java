...
import com.fuzs.sneakymagic.network.message.SAnvilRepairMessage;
...
public class AnvilTweaksElement extends AbstractElement implements ICommonElement {
    ...
    public static final Tags.IOptionalNamedTag<Item> ANVIL_REPAIR_CHANCE_MATERIALS = ItemTags.createOptional(new ResourceLocation(SneakyMagic.MODID, "anvil_repair_chance_materials"));
