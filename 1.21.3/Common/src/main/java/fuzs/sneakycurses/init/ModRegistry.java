...
public class ModRegistry {
    ...
    public static final Holder.Reference<DataComponentType<Unit>> REVEAL_CURSES_DATA_COMPONENT_TYPE = REGISTRIES.register(
            Registries.DATA_COMPONENT_TYPE, "curses_revealed", () -> DataComponentType.<Unit>builder().persistent(
                    Codec.unit(Unit.INSTANCE)).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).build());
